...
namespace MiniProject2_TheQuest
{
    class Game
    {
        ...
        public bool WeaponEquipped(string weaponName)
        {
            return player.WeaponEquipped(weaponName);
        }
        ...
        public void NewLevel(Random random)
        {
            ...
            if(level==8)
            {
                MessageBox.Show("Congragulations!.You have cleared all levels.");
                Application.Exit();
            }
            switch (level)
            {
                ...
                case 4:
                    ...
                    {
                        if (!CheckPlayerInventory("Blue Potion") || (CheckPlayerInventory("Blue Potion") && CheckPotionUsed("Blue Potion")))
                        {
                            WeaponInRoom = new BluePotion(this, GetRandomLocation(random));
                        }
                    }
                ...
                case 8:
                    ...
                    MessageBox.Show("You have cleared all levels");
                    Enemies.Clear();
                    Application.Exit();
                    break;
            }
